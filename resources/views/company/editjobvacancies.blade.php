...
@section('title','Edit Job Vacancies')
        ...
        <div class="col-12">
            <div class="card">
              <div class="card-body">
                ...
                <br>
                <br>
                <form class="form-sample" class="updateJob">
                  @csrf
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control" name="job_name" id="job_name" value="{{$jobVacancy->judul_loker}}"/>
                    ...
                    <div class="col-md-6">
                          ...
                          <div class="col-sm-9">
                            <select name="contract" class="form-select form-select-lg mb-3" aria-label=".form-select-lg example">
                                @foreach ($contract as $item)
                                  @if($item->id == $jobVacancy->id_contract)
                                  <option value="{{$item->id}}" selected>{{$item->contract}}</option>
                                  @endif
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="number" class="form-control" name="salary" id="salary" value="{{$jobVacancy->salary}}"/>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input class="form-control" type="date" placeholder="dd/mm/yyyy" id="date_start" name="date_start" value="{{$jobVacancy->tanggal_awal}}" />
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input class="form-control" type="date" placeholder="dd/mm/yyyy" name="date_end" id="date_end" value="{{$jobVacancy->tanggal_akhir}}"/>
                  ...
                  <div class="form-group">
                    ...
                    <textarea id="my-editor" name="description" class="form-control">{{$jobVacancy->deskripsi}}</textarea>
                  </div>
...
{{-- Sweet Alert --}}
    <script>
      $(document).on('click', '.btn-submit', function (e) {
            ...
            $.ajax({
                url: "{{route('post.company.jobVacancies.edit')}}",
                type: 'POST',
                method:"POST",
                data: {
                  submit: true,
                ...
                success: function(data) {
                  ...
                  console.log(data.message);
                    if (data.status == 'success') {
                      Swal.fire({
                          title: 'Successfully Edit a Job Vacancy!!',
                          text:data.message,
                          icon: 'success',
                ...
                error: function(){
                    Swal.fire({
                        title: 'Failed to Edit a Job Vacancy!',
                        icon: 'error',
                        showConfirmButton: true,
                    });
                }
